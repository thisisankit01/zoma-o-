...
function RestaurantMenu() {
  ...
  return (
  <>
     <h1 className='grid place-content-center pt-6 font-bold text-4xl text-slate-500'>{restaurantMenu.name}</h1>
    <div className='grid grid-flow-col max-sm:grid-flow-row place-content-center pt-10'>


      <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 max-h-[450px]">
    <a href="#">
